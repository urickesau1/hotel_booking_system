...
<!--This is the form for my user login-->
  ...
  <table font-family = "Georgia" class = "table" width="400" height="178"  align="center" cellpadding="1"cellspacing="1" border="3">
    ...
    <tr>
      <td height="48" colspan="2" align="center">
        ...
        <!--If a user neeeds to create a new account, They click on the new user button and are redirected to the userinfo.php page-->
        <a href="userinfo.php">
